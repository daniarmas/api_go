...
var file_main_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x22, 0x65, 0x0a, 0x1d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
...
var file_main_proto_depIdxs = []int32{
	...
	0,  // 6: main.GetVerificationCodeRequest.type:type_name -> main.VerificationCodeType
	11, // 7: main.SignInResponse.user:type_name -> main.User
	14, // 8: main.User.userAddress:type_name -> main.UserAddress
	1,  // 9: main.Item.status:type_name -> main.ItemStatusType
	13, // 10: main.Item.photos:type_name -> main.ItemPhoto
	2,  // 11: main.UserAddress.residenceType:type_name -> main.UserAddress.UserAddressType
	15, // 12: main.UserAddress.coordinates:type_name -> main.Point
	7,  // 13: main.AuthenticationService.CreateVerificationCode:input_type -> main.CreateVerificationCodeRequest
	8,  // 14: main.AuthenticationService.GetVerificationCode:input_type -> main.GetVerificationCodeRequest
	9,  // 15: main.AuthenticationService.SignIn:input_type -> main.SignInRequest
	3,  // 16: main.ItemService.ListItem:input_type -> main.ListItemRequest
	5,  // 17: main.ItemService.GetItem:input_type -> main.GetItemRequest
	17, // 18: main.AuthenticationService.CreateVerificationCode:output_type -> google.protobuf.Empty
	17, // 19: main.AuthenticationService.GetVerificationCode:output_type -> google.protobuf.Empty
	10, // 20: main.AuthenticationService.SignIn:output_type -> main.SignInResponse
	4,  // 21: main.ItemService.ListItem:output_type -> main.ListItemResponse
	6,  // 22: main.ItemService.GetItem:output_type -> main.GetItemResponse
