...
var file_main_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x22, 0xce, 0x07, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73,
	...
	0x63, 0x65, 0x12, 0x27, 0x0a, 0x07, 0x70, 0x6f, 0x6c, 0x79, 0x67, 0x6f, 0x6e, 0x18, 0x0f, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x50, 0x6f, 0x6c, 0x79, 0x67,
	0x6f, 0x6e, 0x52, 0x07, 0x70, 0x6f, 0x6c, 0x79, 0x67, 0x6f, 0x6e, 0x12, 0x2d, 0x0a, 0x0b, 0x63,
	...
	0x72, 0x73, 0x6f, 0x72, 0x22, 0xa5, 0x05, 0x0a, 0x04, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x0e, 0x0a,
	...
	0x73, 0x65, 0x22, 0x00, 0x32, 0x42, 0x0a, 0x0f, 0x42, 0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0x84, 0x01, 0x0a, 0x0b, 0x49, 0x74, 0x65,
...
var file_main_proto_depIdxs = []int32{
	...
	32, // 18: main.Business.polygon:type_name -> main.Polygon
	33, // 19: main.Business.coordinates:type_name -> main.Point
	3,  // 20: main.Business.status:type_name -> main.BusinessStatusType
	2,  // 21: main.Item.status:type_name -> main.ItemStatusType
	29, // 22: main.Item.photos:type_name -> main.ItemPhoto
	4,  // 23: main.Session.platform:type_name -> main.PlatformType
	5,  // 24: main.Session.app:type_name -> main.AppType
	6,  // 25: main.UserAddress.residenceType:type_name -> main.UserAddress.UserAddressType
	33, // 26: main.UserAddress.coordinates:type_name -> main.Point
	22, // 27: main.AuthenticationService.CreateVerificationCode:input_type -> main.CreateVerificationCodeRequest
	23, // 28: main.AuthenticationService.GetVerificationCode:input_type -> main.GetVerificationCodeRequest
	24, // 29: main.AuthenticationService.SignIn:input_type -> main.SignInRequest
	18, // 30: main.AuthenticationService.SignUp:input_type -> main.SignUpRequest
	9,  // 31: main.AuthenticationService.SignOut:input_type -> main.SignOutRequest
	35, // 32: main.AuthenticationService.CheckSession:input_type -> google.protobuf.Empty
	10, // 33: main.AuthenticationService.RefreshToken:input_type -> main.RefreshTokenRequest
	20, // 34: main.AuthenticationService.UserExists:input_type -> main.UserExistsRequest
	7,  // 35: main.AuthenticationService.ListSession:input_type -> main.ListSessionRequest
	16, // 36: main.BusinessService.Feed:input_type -> main.FeedRequest
	12, // 37: main.ItemService.ListItem:input_type -> main.ListItemRequest
	14, // 38: main.ItemService.GetItem:input_type -> main.GetItemRequest
	35, // 39: main.AuthenticationService.CreateVerificationCode:output_type -> google.protobuf.Empty
	35, // 40: main.AuthenticationService.GetVerificationCode:output_type -> google.protobuf.Empty
	25, // 41: main.AuthenticationService.SignIn:output_type -> main.SignInResponse
	19, // 42: main.AuthenticationService.SignUp:output_type -> main.SignUpResponse
	35, // 43: main.AuthenticationService.SignOut:output_type -> google.protobuf.Empty
	21, // 44: main.AuthenticationService.CheckSession:output_type -> main.CheckSessionResponse
	11, // 45: main.AuthenticationService.RefreshToken:output_type -> main.RefreshTokenResponse
	35, // 46: main.AuthenticationService.UserExists:output_type -> google.protobuf.Empty
	8,  // 47: main.AuthenticationService.ListSession:output_type -> main.ListSessionResponse
	17, // 48: main.BusinessService.Feed:output_type -> main.FeedResponse
	13, // 49: main.ItemService.ListItem:output_type -> main.ListItemResponse
	15, // 50: main.ItemService.GetItem:output_type -> main.GetItemResponse
